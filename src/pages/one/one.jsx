...
<div className='compare'>
  ...
  <tr  className="text-justify">
    <td style={{width: '160px'}} scope="col">I will create a High-Quality Video Review of One Song for you to use for Promotion + YouTube Upload</td>
    <td style={{width: '160px'}} scope="col">I will create a High-Quality Video Review of 2-3 Songs for you to use for Promotion + YouTube Upload</td>
    <td style={{width: '160px'}} scope="col">I will create a High-Quality Video Review of 4-6 Songs for you to use for Promotion + YouTube Upload</td>
  </tr>
  </thead>
...
<tr>
  <th scope="row"className="text-start" style={{width: '460px !important' }}>Delivery Time</th>
  <td>4 days</td>
  <td>5 days</td>
  <td>6 days</td>
</tr>
